...
struct engine_control engines [number_of_engines] = {
  ...
  [3] = { .pin_power = 6, .pin_on = A0, .pin_down = A1, .last_status = 0, .start = 0, .operating = false, .runtime = 30000 },
  [4] = { .pin_power = 6, .pin_on = A2, .pin_down = A3, .last_status = 0, .start = 0, .operating = false, .runtime = 30000 }
};
